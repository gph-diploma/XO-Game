...
'''
NEEDs
- 2 player game -- 2 users
- 1 player game -- 1 user & 1 bot mod:[Easy, Hard]

- + - + - + -
- Game class {a_board, Board} [algorithms, print board, clear screen]
- One_Player | Two_Player
- Bot [Easy_Bot, Hard_Bot] 
    ...
    for o in range(10):
        ...
        while i <= 9:
            ...
            if player.a_board[int(move)] == ' ':            # check available place
                ...
                if player.turn=='X': player.turn = 'O'      # change the turn   
                else: player.turn = 'X'    
